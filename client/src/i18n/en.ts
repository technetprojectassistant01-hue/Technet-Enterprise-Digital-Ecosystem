...
export const en = {
  ...
  myAttendance: {
    ...
    scheduleNote: 'Work hours: Monday–Friday 08:00–17:00, Saturday 08:00–13:00. Late is counted from your first check-in of the day, overtime from your last check-out; time worked on a Sunday counts as overtime.',
    colDate: 'DATE',
    colIn: 'TIME IN',
    colOut: 'TIME OUT',
    colWhere: 'LOCATION',
