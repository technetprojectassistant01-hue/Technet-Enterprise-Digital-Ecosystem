...
export const en = {
  ...
  myAttendance: {
    ...
    exportIntro: 'Choose the dates, then download a PDF ready to print. It carries a DRAFT mark until Admin/HR validates those dates.',
    fromLabel: 'FROM',
    toLabel: 'TO',
    ...
    requesting: 'Sending…',
    requested: 'Sent to Admin/HR for validation',
    requestFailed: 'Failed to send the request',
    stateValidated: 'Validated — the PDF downloads without the DRAFT mark.',
    statePending: 'Waiting for Admin/HR to validate these dates. The PDF is marked DRAFT for now.',
    stateNone: 'Not validated yet — the PDF will be marked DRAFT.',
    myRequests: 'MY VALIDATION REQUESTS',
    noRequests: "You haven't asked for any validation yet.",
    validationStatus: { PENDING: 'Pending', VALIDATED: 'Validated', REJECTED: 'Rejected' },
    changedSince: 'Changed since validation — ask again',
    useDates: 'Use these dates',
    withdraw: 'Withdraw',
    removeRequest: 'Remove',
    removeFailed: 'Failed to remove the request',
  },
  ...
  workforce: {
    ...
    validations: {
      intro: 'Employees ask for their attendance to be validated for a date range. Check the PDF, then validate or reject it. Until it is validated their PDF carries a DRAFT mark, and if the attendance changes afterwards it goes back to DRAFT until you validate it again.',
      panel: 'Validation requests',
      ...
      rejected: (person: string) => `Request rejected for ${person}`,
      reopened: 'Back to pending',
      changedSince: 'Attendance changed since it was validated',
      decidedBy: (who: string) => `by ${who}`,
      emptyPending: 'No requests waiting for validation.',
      empty: 'No validation requests.',
      loadFailed: 'Failed to load validation requests',
      decideFailed: 'Failed to save the decision',
      rejectTitle: (person: string) => `Reject request — ${person}`,
      reason: 'REASON (OPTIONAL)',
      status: { PENDING: 'Pending', VALIDATED: 'Validated', REJECTED: 'Rejected' },
    },
    payroll: {
      title: 'Payroll',
        ...
        faqs: [
          {
            ...
            a: [
              'Use the "My Attendance" card on the Attendance page. Check the arrival time (it\'s filled in for you), enter your transport cost (enter 0 if you had none), type the site you are at if you want (for example the client or building), type your location, then tap "Check In".',
          ...
          },
          {
            ...
            a: [
              ...
              'Until Admin or HR has validated those dates the PDF is marked DRAFT. Tap "Request validation" to ask them; you\'ll get a notification once they decide. If your attendance for those dates changes afterwards, it goes back to DRAFT until they validate it again.',
            ],
          },
          {
