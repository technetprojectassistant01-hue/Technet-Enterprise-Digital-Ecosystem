...
export const en = {
  ...
  attendance: {
    ...
    transportNote: 'WHY IS TRANSPORT ZERO?',
    transportNotePlaceholder: 'Explain why no transport cost applies',
    ...
    zeroTransportNoteRequired: 'Explain why transport cost is zero',
  ...
  ops: {
    ...
    irDetail: {
      ...
      rejectionComment: 'Why is this report being rejected?',
      rejectionCommentPlaceholder: 'Enter the correction or reason for rejection',
      rejectionCommentRequired: 'A rejection comment is required',
      confirmRejection: 'Reject Report',
    ...
    anomalies: {
      ...
      subtitle: 'Employees with two consecutive missed or out-of-radius compliance checks during an open shift.',
      loadFailed: 'Failed to load anomalies',
      noOpen: 'No open anomalies.',
      severityStandard: 'Standard',
      severityHigh: 'High',
      firstCheck: 'First check',
      secondCheck: 'Second check',
      statusMissed: 'Missed',
      statusOutOfRadius: (distance: string) => `Out of radius (${distance})`,
    ...
    auditCheck: {
      ...
      pendingIntro: "Your supervisor's app asked you to confirm you're on site.",
      confirmButton: "Confirm you're on site",
      confirming: 'Confirming…',
      confirmed: 'Thanks — recorded.',
      alreadyAnswered: 'This check has already been recorded.',
      expired: 'This check has expired.',
      locationDenied: 'Location permission is required to confirm this check.',
      loadFailed: 'This check could not be found.',
      confirmFailed: 'Failed to record your confirmation',
    },
  },
  ...
  hr: {
    ...
    overview: {
      ...
      validationAwaiting: 'ATTENDANCE AWAITING VALIDATION',
      thisMonth: 'This month',
