...
export const fr: Dict = {
  ...
  nav: {
    ...
    'Attendance Anomalies': 'Anomalies de présence',
  ...
  overview: {
    ...
    notLinked:
      "Votre compte n'est pas encore lié à une fiche employé : le pointage n'est donc pas disponible. Demandez à un administrateur de le lier dans Technet HR → Employés.",
  },
  ...
  attendance: {
    ...
    transportNote: 'POURQUOI LE TRANSPORT EST ZERO ?',
    transportNotePlaceholder: 'Expliquez pourquoi aucun frais de transport ne s’applique',
    location: 'LIEU (FACULTATIF)',
    wherePlaceholder: 'Ville ou quartier, ex. Ébène',
    site: 'SITE',
    sitePlaceholder: 'Client ou nom du site, ex. Celero niveau 5',
    ...
    zeroTransportNoteRequired: 'Expliquez pourquoi les frais de transport sont à zéro',
    checkInFailed: "Échec du pointage d'arrivée",
    checkOutFailed: 'Échec du pointage de départ',
    outboxCheckIn: (place: string) => (place ? `Arrivée — ${place}` : 'Arrivée'),
  ...
  staffAttendance: {
    ...
    decideFailed: "Échec de l'enregistrement de la décision",
    onSiteNow: (n) => (n === 1 ? '1 pointage en cours' : `${n} pointages en cours`),
    peopleThisMonth: (n) => (n === 1 ? '1 personne' : `${n} personnes`),
    viewFull: 'Registre complet',
    stillIn: 'Toujours pointé',
    noSite: '—',
    groupEntered: 'SAISI PAR LE PERSONNEL',
    groupSystem: "ENREGISTRÉ PAR L'APPLICATION",
    colStaff: 'PERSONNEL',
    colDate: 'DATE',
    colIn: 'ENTRÉE',
    colOut: 'SORTIE',
    colLocationIn: "LIEU D'ENTRÉE",
    colLocationOut: 'LIEU DE SORTIE',
    colGpsIn: 'GPS ENTRÉE',
    colGpsOut: 'GPS SORTIE',
    colFlags: 'ALERTES',
  ...
  myAttendance: {
    ...
    exportIntro: 'Choisissez les dates, puis téléchargez un PDF prêt à imprimer. Il porte la mention BROUILLON tant que les RH n’ont pas validé le mois.',
    fromLabel: 'DU',
    toLabel: 'AU',
    rangeInvalid: 'La date de fin doit être égale ou postérieure à la date de début',
    futureNotAllowed: "La date de fin ne peut pas dépasser aujourd'hui",
    downloadPdf: 'Télécharger le PDF',
    downloading: 'Préparation…',
    downloadFailed: 'Échec du téléchargement du PDF',
    stateValidated: 'Validé par les RH — le PDF se télécharge sans la mention BROUILLON.',
    stateNone: "Les RH valident les présences à la fin de chaque mois. D'ici là, le PDF porte la mention BROUILLON.",
    stateChanged: 'Vos présences ont changé après la validation des RH : le PDF porte la mention BROUILLON jusqu’à une nouvelle validation.',
  },
  ...
  myLeave: {
    ...
    updated: 'Demande de congé modifiée — les RH vont l’examiner',
    updateFailed: 'Impossible de modifier la demande',
  ...
  ops: {
    ...
    daily: {
      ...
      colPhotos: 'PHOTOS',
      photosLabel: (count: number, max: number) => `PHOTOS (FACULTATIF, ${count}/${max})`,
      addPhoto: 'Ajouter une photo',
      addingPhotos: 'Ajout…',
      removePhoto: 'Retirer la photo',
      photosLimit: (max: number) => `Vous pouvez joindre jusqu'à ${max} photos`,
      photoReadFailed: "Impossible d'ajouter cette photo",
    ...
    irDetail: {
      ...
      rejectionComment: 'Pourquoi ce rapport est-il refusé ?',
      rejectionCommentPlaceholder: 'Indiquez la correction ou la raison du refus',
      rejectionCommentRequired: 'Un commentaire de refus est obligatoire',
      confirmRejection: 'Refuser le rapport',
    ...
    team: {
      ...
      allTechnicians: 'Tous les techniciens',
      includePastEmployees: 'Inclure les anciens employés',
    ...
    anomalies: {
      ...
      subtitle: "Employés ayant deux contrôles de conformité manqués ou hors zone consécutifs pendant un service en cours.",
      loadFailed: 'Échec du chargement des anomalies',
      noOpen: 'Aucune anomalie ouverte.',
      severityStandard: 'Standard',
      severityHigh: 'Élevée',
      firstCheck: 'Premier contrôle',
      secondCheck: 'Deuxième contrôle',
      statusMissed: 'Manqué',
      statusOutOfRadius: (distance: string) => `Hors zone (${distance})`,
      markFalsePositive: 'Marquer faux positif',
      confirmViolation: 'Confirmer la violation',
      dismiss: 'Ignorer',
      deciding: 'Enregistrement…',
      decideFailed: "Échec de l'enregistrement de la décision",
      decidedBy: (name: string) => `Décidé par ${name}`,
    },
    auditCheck: {
      title: 'Contrôle de conformité',
      pendingIntro: "L'application de votre superviseur vous demande de confirmer que vous êtes sur site.",
      confirmButton: 'Confirmer votre présence sur site',
      confirming: 'Confirmation…',
      confirmed: 'Merci — enregistré.',
      alreadyAnswered: 'Ce contrôle a déjà été enregistré.',
      expired: 'Ce contrôle a expiré.',
      locationDenied: 'La permission de localisation est requise pour confirmer ce contrôle.',
      loadFailed: 'Ce contrôle est introuvable.',
      confirmFailed: "Échec de l'enregistrement de votre confirmation",
    },
  },
  ...
  tools: {
    ...
    subtitleManager: 'Enregistrez les outils et équipements, voyez qui détient chacun et enregistrez les retours.',
    add: 'Ajouter un outil',
    editTitle: "Modifier l'outil",
    myTools: 'Mes outils',
    myToolsEmpty: "Vous n'avez aucun outil sorti. Demandez ce qu'il vous faut dans Demandes d'outils.",
    since: (date: string) => `Depuis le ${date}`,
    dueBack: (date: string) => `Retour prévu le ${date}`,
    overdue: 'En retard',
    overdueSince: (date: string) => `En retard — retour prévu le ${date}`,
    statTotal: 'TOTAL OUTILS',
    statAvailable: 'DISPONIBLES',
    statMine: 'MES OUTILS',
    register: 'Registre des outils',
    search: 'RECHERCHE',
    searchPlaceholder: 'Numéro, nom, numéro de série...',
    empty: "Aucun outil n'a encore été enregistré.",
    emptyManager: 'Aucun outil. Ajoutez un premier outil pour commencer le registre.',
    colTag: 'N°',
    colHeldBy: 'DÉTENU PAR',
    colCondition: 'ÉTAT',
    markReturned: 'Marquer rendu',
    history: 'Historique',
    historyTitle: (tool: string) => `Historique — ${tool}`,
    historyEmpty: "Cet outil n'a jamais été sorti.",
    historyLine: (issued: string, returned: string | null, request: string | null) =>
      `Sorti le ${issued}${returned ? ` · rendu le ${returned}` : ' · pas encore rendu'}${request ? ` · ${request}` : ''}`,
    historyFailed: "Impossible de charger l'historique",
    namePlaceholder: 'ex. Perceuse sans fil',
    categoryPlaceholder: 'ex. Outillage électrique',
    storedAt: 'RANGÉ À',
    storedAtPlaceholder: 'ex. Magasin principal, étagère B',
    tagHint: "Un numéro (TL-0001, TL-0002…) est attribué automatiquement — inscrivez-le sur l'outil.",
    statusLockedWhileOut: 'Sorti — enregistrez son retour pour changer le statut.',
    nameRequired: 'Le nom est obligatoire',
    created: 'Outil ajouté',
    updated: 'Outil modifié',
    saveFailed: "Impossible d'enregistrer l'outil",
    deleteTitle: "Supprimer l'outil",
    deleteMessage: (tool: string) => `Supprimer ${tool} ? Cette action est irréversible.`,
    deleteFailed: "Impossible de supprimer l'outil",
    loadFailed: 'Impossible de charger les outils',
    returnTitle: 'Enregistrer le retour',
    returnBody: (tool: string, person: string) => `${tool}, rendu par ${person}.`,
    returnCondition: 'ÉTAT AU RETOUR',
    damagedHint: 'Un outil endommagé passe En réparation et ne peut pas être sorti tant que vous ne le remettez pas Disponible.',
    returned: (tool: string) => `${tool} rendu`,
    returnFailed: "Impossible d'enregistrer le retour",
    status: {
  ...
  toolRequests: {
    title: "Demandes d'outils",
    subtitle: 'Demandez au magasin les outils et équipements dont vous avez besoin. Vous recevrez une notification quand ils seront prêts.',
    subtitleManager: "Demandes d'outils et d'équipements. Sortez des outils disponibles pour une demande, ou refusez-la.",
    requestTools: 'Demander des outils',
    notLinked: "Aucun dossier employé n'est lié à votre compte, vous ne pouvez donc pas demander d'outils. Contactez les RH.",
    statPending: 'DEMANDES EN ATTENTE',
    statApproved: 'DEMANDES APPROUVÉES',
    statAll: 'TOUTES LES DEMANDES',
    allRequests: 'Toutes les demandes',
    myRequests: 'Mes demandes',
    empty: "Vous n'avez encore demandé aucun outil.",
    emptyManager: "Aucune demande d'outils pour l'instant.",
    loadFailed: "Impossible de charger les demandes d'outils",
    colNumber: 'DEMANDE N°',
    ...
    issue: 'Sortir',
    edit: 'Modifier',
    editTitle: (number: string) => `Modifier la demande — ${number}`,
    updated: 'Demande modifiée — le magasin a été prévenu',
    updateFailed: 'Impossible de modifier la demande',
    deleteTitle: "Supprimer la demande d'outils",
    deleteMessage: (number: string) => `Supprimer la demande ${number} ? Cette action est irréversible.`,
    deleted: 'Demande supprimée',
    deleteFailed: 'Impossible de supprimer la demande',
    itemsLabel: 'OUTILS OU ÉQUIPEMENTS NÉCESSAIRES',
    itemsPlaceholder: 'ex. 1 perceuse sans fil, 1 testeur de câble, une échelle de 3 m',
    typeOrBrandLabel: 'TYPE OU MARQUE (FACULTATIF)',
    typeOrBrandPlaceholder: 'ex. Makita 18V, Fluke',
    typeOrBrandShort: 'Type/marque :',
    purposeLabel: 'POUR QUOI (FACULTATIF)',
    purposePlaceholder: 'ex. Installation à Ébène',
    itemsRequired: 'Indiquez les outils ou équipements nécessaires',
    submit: 'Envoyer la demande',
    submitted: 'Demande envoyée — le magasin vous tiendra informé',
    submitFailed: "Impossible d'envoyer la demande",
    issueTitle: (number: string) => `Sortir des outils — ${number}`,
    requestedByLine: (person: string) => `Demandé par ${person}`,
    pickTools: 'CHOISISSEZ LES OUTILS À REMETTRE',
    noneAvailable: 'Aucun outil disponible ne correspond.',
    pickAtLeastOne: 'Choisissez au moins un outil',
    expectedReturn: 'RETOUR PRÉVU (FACULTATIF)',
    issueCount: (n: number) => (n <= 1 ? `Sortir ${n} outil` : `Sortir ${n} outils`),
    issued: (n: number, person: string) => `${n <= 1 ? `${n} outil sorti` : `${n} outils sortis`} pour ${person}`,
    issueFailed: 'Impossible de sortir les outils',
    rejectTitle: (number: string) => `Refuser — ${number}`,
    rejectReason: 'MOTIF (FACULTATIF)',
    rejectPlaceholder: 'ex. Aucun en stock cette semaine',
  ...
  hr: {
    ...
    overview: {
      ...
      overtimeAwaiting: "HEURES SUPP. EN ATTENTE D'APPROBATION",
      validationAwaiting: 'PRÉSENCES À VALIDER',
      thisMonth: 'Ce mois-ci',
  ...
  workforce: {
    ...
    overtime: {
      intro: "Les heures supplémentaires sont calculées à partir des pointages des techniciens selon les horaires standard. Chaque journée reste en attente jusqu'à votre validation ou refus ; seules les heures validées apparaissent dans la présence du technicien.",
      panel: 'Heures supplémentaires',
      statPending: 'EN ATTENTE DE VALIDATION',
      statApproved: 'VALIDÉES CE MOIS-CI',
      colWorked: 'ARRIVÉE → DÉPART',
      colOvertime: 'HEURES SUP.',
      emptyPending: "Aucune heure supplémentaire en attente ce mois-ci.",
      empty: 'Aucune heure supplémentaire ce mois-ci.',
      loadFailed: 'Impossible de charger les heures supplémentaires',
      decideFailed: "Impossible d'enregistrer la décision",
      approved: (person: string) => `Heures sup. validées pour ${person}`,
      rejected: (person: string) => `Heures sup. refusées pour ${person}`,
      undo: 'Annuler',
    ...
    validations: {
      intro: "À la fin de chaque mois, vérifiez le PDF de présence de chaque employé et validez-le. Tant que ce n'est pas fait, son PDF porte la mention BROUILLON. Si ses présences changent ensuite, il apparaît comme modifié et redevient BROUILLON jusqu'à une nouvelle validation.",
      panel: 'Validation mensuelle',
      statEmployees: 'EMPLOYÉS AVEC PRÉSENCES',
      statValidated: 'VALIDÉS',
      statToDo: 'NON VALIDÉS',
      colDays: 'JOURS',
      colCheckIns: 'POINTAGES',
      viewPdf: 'PDF',
      validate: 'Valider',
      validateAgain: 'Revalider',
      validateAll: 'Tout valider',
      validatingAll: 'Validation…',
      undo: 'Annuler',
      validated: (person: string) => `Présences validées pour ${person}`,
      validatedAll: (count: number) => `${count} employé${count === 1 ? '' : 's'} validé${count === 1 ? '' : 's'}`,
      undone: 'Validation retirée — le PDF est de nouveau BROUILLON',
      monthNotOver: 'Ce mois peut être validé à partir de son dernier jour.',
      state: { NOT_VALIDATED: 'Non validé', VALIDATED: 'Validé', CHANGED: 'Modifié depuis la validation' },
      validatedBy: (who: string, date: string) => `par ${who} le ${date}`,
      empty: 'Aucune présence enregistrée ce mois-ci.',
      loadFailed: 'Échec du chargement des présences à valider',
      actionFailed: "Échec de l'enregistrement de la validation",
    },
    payroll: {
      title: 'Paie',
    ...
    sections: [
      ...
      },
      {
        ...
        faqs: [
          ...
          {
            q: 'Comment obtenir mes présences en PDF ?',
            a: [
              'Sur la page Présence, touchez « Exporter en PDF » sur la carte « Ma présence », choisissez les dates, puis touchez « Télécharger le PDF ». Il est prêt à imprimer.',
              "Le PDF porte la mention BROUILLON tant que les RH n'ont pas validé vos présences, ce qu'ils font à la fin de chaque mois. Vous recevrez une notification quand votre mois sera validé ; le même téléchargement arrivera alors sans la mention BROUILLON. Si vos présences de ce mois changent ensuite, il redevient BROUILLON jusqu'à une nouvelle validation.",
            ],
          },
          {
        ...
        faqs: [
          {
            ...
            a: [
              "Les arrivées, départs, rapports journaliers et rapports d'intervention sont enregistrés sur votre téléphone et envoyés automatiquement dès le retour du réseau. Inutile de les renvoyer.",
          ...
          },
          {
            ...
            a: [
              "Oui — vos ordres de travail et vos rapports affichent la dernière version chargée par votre téléphone quand il avait du réseau. Ouvrez-les une fois connecté pour qu'ils soient enregistrés sur votre téléphone.",
            ],
          },
        ],
      },
