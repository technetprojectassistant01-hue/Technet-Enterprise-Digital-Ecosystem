...
export const fr: Dict = {
  ...
  myAttendance: {
    ...
    exportIntro: "Choisissez les dates, puis téléchargez un PDF prêt à imprimer. Il porte la mention BROUILLON tant que l'Admin/RH n'a pas validé ces dates.",
    fromLabel: 'DU',
    toLabel: 'AU',
    ...
    requesting: 'Envoi…',
    requested: "Envoyé à l'Admin/RH pour validation",
    requestFailed: "Échec de l'envoi de la demande",
    stateValidated: 'Validé — le PDF se télécharge sans la mention BROUILLON.',
    statePending: "En attente de validation par l'Admin/RH. Le PDF porte la mention BROUILLON pour l'instant.",
    stateNone: 'Pas encore validé — le PDF portera la mention BROUILLON.',
    myRequests: 'MES DEMANDES DE VALIDATION',
    noRequests: "Vous n'avez encore demandé aucune validation.",
    validationStatus: { PENDING: 'En attente', VALIDATED: 'Validée', REJECTED: 'Refusée' },
    changedSince: 'Modifié depuis la validation — redemandez',
    useDates: 'Utiliser ces dates',
    withdraw: 'Retirer',
    removeRequest: 'Supprimer',
    removeFailed: 'Échec de la suppression de la demande',
  },
  ...
  workforce: {
    ...
    validations: {
      intro: "Les employés demandent la validation de leurs présences pour une période. Vérifiez le PDF, puis validez ou refusez. Tant qu'il n'est pas validé, leur PDF porte la mention BROUILLON ; si les présences changent ensuite, il redevient BROUILLON jusqu'à une nouvelle validation.",
      panel: 'Demandes de validation',
      statPending: 'EN ATTENTE DE VALIDATION',
      statValidated: 'VALIDÉES',
      colPeriod: 'PÉRIODE',
      colRequested: 'DEMANDÉE LE',
      viewPdf: 'PDF',
      validate: 'Valider',
      validateAgain: 'Revalider',
      reopen: 'Annuler',
      validated: (person: string) => `Présences validées pour ${person}`,
      rejected: (person: string) => `Demande refusée pour ${person}`,
      reopened: 'Remis en attente',
      changedSince: 'Présences modifiées depuis la validation',
      decidedBy: (who: string) => `par ${who}`,
      emptyPending: 'Aucune demande en attente de validation.',
      empty: 'Aucune demande de validation.',
      loadFailed: 'Échec du chargement des demandes de validation',
      decideFailed: "Échec de l'enregistrement de la décision",
      rejectTitle: (person: string) => `Refuser la demande — ${person}`,
      reason: 'MOTIF (FACULTATIF)',
      status: { PENDING: 'En attente', VALIDATED: 'Validée', REJECTED: 'Refusée' },
    },
    payroll: {
      title: 'Paie',
        ...
        faqs: [
          {
            ...
            a: [
              "Utilisez la carte « Ma présence » sur la page Présence. Vérifiez l'heure d'arrivée (elle est remplie pour vous), saisissez vos frais de transport (0 si vous n'en avez pas), indiquez si vous le souhaitez le site (par exemple le client ou le bâtiment), indiquez le lieu, puis touchez « Pointer l'arrivée ».",
          ...
          },
          {
            ...
            a: [
              ...
              'Tant que l\'Admin ou les RH n\'ont pas validé ces dates, le PDF porte la mention BROUILLON. Touchez « Demander la validation » pour leur demander ; vous recevrez une notification dès leur décision. Si vos présences pour ces dates changent ensuite, il redevient BROUILLON jusqu\'à une nouvelle validation.',
            ],
          },
          {
