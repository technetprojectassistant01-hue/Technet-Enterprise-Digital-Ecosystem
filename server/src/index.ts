...
import publicHolidaysRouter from "./routes/publicHolidays";
...
import attendanceValidationsRouter from "./routes/attendanceValidations";
import { employeeDocumentsRouter, myDocumentsRouter } from "./routes/employeeDocuments";
...
app.use("/api/attendance-validations", attendanceValidationsRouter);
app.use("/api/my-documents", myDocumentsRouter);
